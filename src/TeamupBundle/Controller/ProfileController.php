...
class ProfileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $profiles = $em->getRepository('TeamupBundle:Profile')->findAll();
    ...
    {
        $profile = new Profile();
        $form = $this->createForm('TeamupBundle\Form\ProfileType', $profile);
    ...
    {
        $deleteForm = $this->createDeleteForm($profile);
        $editForm = $this->createForm('TeamupBundle\Form\ProfileType', $profile);
